            ...
            GooglePlacesAutocompleteService = (function () {
                ...
                GooglePlacesAutocompleteService.prototype.getSuggestions = function (str) {
                    ...
                    return new Promise(function (resolve, reject) {
                        return _this._googleAutocomplete.getPlacePredictions(request, function (results, status) {
...
System.register("address-autocomplete.component", ['angular2/core', "google-places-autocomplete.service", "address"], function(exports_6, context_6) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            AddressAutocompleteComponent = (function () {
                ...
                AddressAutocompleteComponent.prototype.showSuggestions = function (str) {
                    var _this = this;
                 ...
                 * When the user
                 */
                AddressAutocompleteComponent.prototype.useCurrentSuggestion = function () {
                    var _this = this;
                    ...
                    var placeId = this.selectedSuggestion.id;
                ...
                AddressAutocompleteComponent.prototype.onBlurHouseNumber = function (houseNumber) {
                    ...
                    var tempAddress = new address_2.Address();
                    Object.assign(tempAddress, this.address);
                    tempAddress.houseNumber = houseNumber;
                    this.autoCompleteService.getSuggestions(tempAddress.toString()).then(function (results) {
                        ...
                        _this.autoCompleteService.getSuggestionDetails(bestSuggestion.id).then(function (placeDetail) {
                            if (placeDetail.address.isComplete()) {
                                _this.selectedSuggestion = bestSuggestion;
                                _this.useCurrentSuggestion();
                            }
                            else {
...
System.register("ng2-address", ["address-autocomplete.component", "address", "google-places-autocomplete.service", "place-details", "place-suggestion"], function(exports_7, context_7) {
    "use strict";
    ...
    return {
        setters:[
            ...
            function (address_3_1) {
                exportStar_1(address_3_1);
            },
